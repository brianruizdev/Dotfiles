...
PATH=/root/.local/bin:/snap/bin:/usr/sandbox/:/usr/local/bin:/usr/bin:/bin:/usr/local/games:/usr/games:/usr/share/games:/usr/local/sbin:/usr/sbin:/sbin:/usr/local/bin:/usr/bin:/bin:/usr/local/games:/usr/games:~/.console-ninja/.bin:$PATH
...
bindkey "^[[H" beginning-of-line # Home -> start line
bindkey "^[[F" end-of-line # End -> end line
bindkey "^[[3~" delete-char # Del; -> delete char
# bindkey "^H" backward-kill-word # Ctrl + Backspace; -> delete char
